...
This module provides a file-based caching system with least-recently-used
eviction policy, time-based expiration, and size limiting to prevent
unbounded growth.
"""
...
from yahoofinance.core.config import CACHE, FILE_PATHS
