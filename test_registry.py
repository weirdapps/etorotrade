...
from yahoofinance.utils.dependency_injection import Registry, inject, provides, lazy_import
...
def test_decorator_registration():
    ...
    @registry.register('no_parens')  # Use string key for now until no-parentheses syntax is fully tested
    def no_parens():
