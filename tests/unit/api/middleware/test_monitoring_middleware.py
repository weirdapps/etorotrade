...
from yahoofinance.api.middleware.monitoring_middleware import (
    MonitoredProviderMixin, MonitoringMiddleware, apply_monitoring
)
from yahoofinance.api.providers.base_provider import AsyncFinanceDataProvider, FinanceDataProvider
from yahoofinance.core.errors import YFinanceError, APIError, MonitoringError
...
def setup_mocks():
    ...
    with patch('yahoofinance.api.middleware.monitoring_middleware.circuit_breaker_monitor', 
               mock_circuit_breaker_monitor):
        with patch('yahoofinance.api.middleware.monitoring_middleware.request_counter',
                  mock_request_counter):
            with patch('yahoofinance.api.middleware.monitoring_middleware.request_duration',
...
class TestApplyMonitoring:
    ...
    def test_apply_monitoring_to_sync_provider(self):
        ...
        with patch('yahoofinance.api.middleware.monitoring_middleware.MonitoringMiddleware.wrap_method',
