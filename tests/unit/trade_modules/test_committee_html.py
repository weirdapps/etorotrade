...
def test_report_renders_currency_exposure_section():
    synth = _minimal_synth()
    synth["concordance"] = [
        {"ticker": "NVDA", "action": "HOLD", "conviction": 5, "currency_zone": "USD"},
        {"ticker": "GLD", "action": "HOLD", "conviction": 5, "currency_zone": "USD"},
        {"ticker": "0700.HK", "action": "HOLD", "conviction": 5, "currency_zone": "HKD"},
        {"ticker": "DTE.DE", "action": "HOLD", "conviction": 5, "currency_zone": "EUR"},
        {"ticker": "6758.T", "action": "HOLD", "conviction": 5, "currency_zone": "JPY"},
    ]
    risk = {
        "fx_data": {
            "pairs": {
                "EUR/USD": {"rate": 1.08, "change_1m": -0.5, "trend": "STABLE"},
            },
            "dxy": {"value": 104.5},
        }
    }
