...
class TestConfigurationValidator:
    ...
    def test_validate_environment_variables_missing(self, config_validator):
        ...
        with patch.object(config_validator, "__init__", lambda self: None):
            ...
            with patch(
                "trade_modules.trade_cli.ConfigurationValidator.validate_environment_variables"
            ) as mock_validate:
...
class TestAsyncHandlers:
    ...
    async def test_handle_trade_analysis_success(self):
        ...
        with (
            patch("trade_modules.trade_cli.get_provider_instance") as mock_get_provider,
...
class TestMainAsync:
    ...
    async def test_main_async_with_defaults(self):
        ...
        with (
            patch("trade_modules.trade_cli.registry") as mock_registry,
...
class TestSetupSecureFileCopy:
    ...
    def test_setup_secure_file_copy_permissions(self):
        ...
        with patch("os.path.exists") as mock_exists, patch("pathlib.Path.mkdir") as mock_mkdir:
