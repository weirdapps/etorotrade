...
from trade_modules.trade_filters import PortfolioFilter, TradingCriteriaFilter
...
class TestTradingCriteriaFilterPriceRange:
    ...
    def filter_obj(self):
        ...
        return TradingCriteriaFilter(criteria_config={"min_price": 10.0, "max_price": 500.0})
...
class TestTradingCriteriaFilterSectors:
    ...
    def filter_obj(self):
        ...
        return TradingCriteriaFilter(criteria_config={"sectors_exclude": ["Energy", "Utilities"]})
...
class TestTradingCriteriaFilterRegions:
    ...
    def filter_obj(self):
        ...
        return TradingCriteriaFilter(criteria_config={"regions_include": ["US"]})
...
class TestFilterIntegration:
    ...
    def test_chain_filters(self):
        ...
        criteria_filter = TradingCriteriaFilter(
            criteria_config={
                "min_market_cap": 10e9,
                "max_pe_ratio": 40,
            }
