...
from trade_modules.boundaries.trade_modules_boundary import (
    ITradeModulesBoundary,
    TradeModulesBoundary,
)
from trade_modules.boundaries.yahoo_finance_boundary import (
    IYahooFinanceBoundary,
...
class TestBoundaryValidation:
    ...
    def test_config_boundary_validate_trading_criteria(self):
        ...
        config = {"min_market_cap": 1e9, "max_pe_ratio": 25, "min_volume": 100000}
    ...
    def test_config_boundary_validate_display_config(self):
        ...
        boundary = ConfigBoundary()
        config = {"decimal_places": 2, "currency_symbol": "$", "date_format": "%Y-%m-%d"}
    ...
    def test_config_boundary_validate_provider_config(self):
        ...
        boundary = ConfigBoundary()
        config = {"default_provider": "yahoo_finance", "timeout": 30, "max_retries": 3}
