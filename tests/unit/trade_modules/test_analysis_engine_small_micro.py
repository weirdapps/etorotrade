...
# (SNAP etc.) become time-bombs that fail every earnings season. Mock to a
...
class TestMinimumMarketCapFilter:
    ...
    def test_small_cap_just_above_threshold(self):
        ...
        assert result.loc["SMALLCAP", "BS"] in [
            "B",
            "H",
            "S",
        ], "Should get valid signal above $2B with sufficient analysts"
