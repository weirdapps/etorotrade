...
class TestEarningsCalendar(unittest.TestCase):
    ...
    def test_get_trading_date(self):
        ...
        self.assertEqual(
            self.calendar.get_trading_date(pre_market),
            '2024-01-01'
        )
        ...
        self.assertEqual(
            self.calendar.get_trading_date(after_market),
            '2024-01-02'
        )
        ...
        self.assertEqual(
            self.calendar.get_trading_date(market_close),
            '2024-01-02'
        )
    ...
    def test_major_stocks_list(self):
        ...
        self.assertEqual(
            len(self.calendar.major_stocks),
            len(set(self.calendar.major_stocks))
        )
