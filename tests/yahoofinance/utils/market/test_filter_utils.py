    ...
    return [
        {
            ...
            'market_cap': 2.5e12, 'sector': 'Technology',
            'performance': {'1m': 5.0, '3m': 12.0, '6m': 20.0, '1y': 35.0},
            'upside': 20.0, 'buy_percentage': 85.0,
            'pe_trailing': 30.0, 'pe_forward': 25.0, 'peg_ratio': 1.5
        },
        {
            'ticker': 'MSFT', 'company': 'Microsoft Corp', 
            'market_cap': 2.4e12, 'sector': 'Technology',
            'performance': {'1m': 3.5, '3m': 9.0, '6m': 15.0, '1y': 30.0},
            'upside': 16.7, 'buy_percentage': 80.0,
            'pe_trailing': 35.0, 'pe_forward': 30.0, 'peg_ratio': 2.0
        },
        {
            'ticker': 'GOOG', 'company': 'Alphabet Inc', 
            'market_cap': 1.8e12, 'sector': 'Technology',
            'performance': {'1m': 4.0, '3m': 10.0, '6m': 18.0, '1y': 28.0},
            'upside': 20.0, 'buy_percentage': 90.0,
            'pe_trailing': 25.0, 'pe_forward': 20.0, 'peg_ratio': 1.0
        },
        {
            'ticker': 'AMZN', 'company': 'Amazon.com Inc', 
            'market_cap': 1.7e12, 'sector': 'Consumer Cyclical',
            'performance': {'1m': 2.5, '3m': 7.0, '6m': 12.0, '1y': 25.0},
            'upside': 14.3, 'buy_percentage': 75.0,
            'pe_trailing': 60.0, 'pe_forward': 50.0, 'peg_ratio': 2.5
        },
        {
            'ticker': 'META', 'company': 'Meta Platforms', 
            'market_cap': 1.0e12, 'sector': 'Technology',
            'performance': {'1m': 1.5, '3m': 5.0, '6m': 10.0, '1y': 20.0},
            'upside': 14.3, 'buy_percentage': 70.0,
            'pe_trailing': 25.0, 'pe_forward': 20.0, 'peg_ratio': 1.8
        },
        {
            'ticker': 'TSLA', 'company': 'Tesla Inc', 
            'market_cap': 8.0e11, 'sector': 'Consumer Cyclical',
            'performance': {'1m': -2.0, '3m': -5.0, '6m': 8.0, '1y': 15.0},
            'upside': -25.0, 'buy_percentage': 50.0,
            'pe_trailing': 100.0, 'pe_forward': 150.0, 'peg_ratio': 4.0
        },
        {
            'ticker': 'NFLX', 'company': 'Netflix Inc', 
            'market_cap': 2.5e11, 'sector': 'Communication Services',
            'performance': {'1m': -1.0, '3m': -3.0, '6m': 5.0, '1y': 10.0},
            'upside': -16.7, 'buy_percentage': 60.0,
            'pe_trailing': 40.0, 'pe_forward': 35.0, 'peg_ratio': 2.2
        },
        {
            'ticker': 'JPM', 'company': 'JPMorgan Chase', 
            'market_cap': 5.0e11, 'sector': 'Financial Services',
            'performance': {'1m': 1.0, '3m': 3.0, '6m': 7.0, '1y': 15.0},
            'upside': 16.7, 'buy_percentage': 70.0,
            'pe_trailing': 12.0, 'pe_forward': 10.0, 'peg_ratio': 1.2
        }
    ]
