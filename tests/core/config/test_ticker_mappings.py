    ...
    def test_get_normalized_ticker_edge_cases(self):
        ...
        edge_cases = [
            ...
            (
                "  NVO  ",
                "  NVO  ",
            ),  # Whitespace handling is done by standardize_ticker_format, not get_normalized_ticker
        ]
...
class TestIntegration:
    ...
    def test_portfolio_filtering_scenario(self):
        ...
        for opportunity in buy_opportunities:
            is_already_held = any(
                are_equivalent_tickers(opportunity, holding) for holding in portfolio_holdings
            )
