...
def analyze_insider_transactions(ticker):
    """Analyze insider transactions since the second last earnings date."""
    ...
    return (buy_count / total_transactions * 100) if total_transactions > 0 else None, total_transactions