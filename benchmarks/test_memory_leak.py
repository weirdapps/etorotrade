...
def _process_top_consumers(snapshot_start, snapshot_end) -> List[Dict[str, Any]]:
    """Processes snapshot comparison to find top memory consumers."""
...
async def find_memory_leaks_async(func, *args, iterations: int = 10, **kwargs) -> Tuple[bool, Dict[str, Any]]:
    ...
    # Compare snapshots and process top memory consumers
    memory_growth = _process_top_consumers(snapshot_start, snapshot_end)
