...
class ConfigBoundary(IConfigBoundary):
    ...
    def get_trading_criteria_config(self) -> dict[str, Any]:
        ...
        if "trading_criteria" not in self._config_cache:
            try:
                ...
                buy_criteria = TradeConfig.get_thresholds(
                    "m", "buy", ticker="AAPL", market_cap=100e9
                )
                sell_criteria = TradeConfig.get_thresholds(
                    "m", "sell", ticker="AAPL", market_cap=100e9
                )
    ...
    def _get_default_provider_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "headers": {"User-Agent": "YFinance-Client/1.0"},
            "verify_ssl": True,
            "proxy": None,
        }
