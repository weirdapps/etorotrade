...
class TradingCriteriaFilter:
    ...
    def apply_criteria(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            self.logger.info(
                f"Applied trading criteria: {initial_count} → {final_count} "
...
class PortfolioFilter:
    ...
    def filter_new_opportunities(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            self.logger.info(
                f"Portfolio filter (new): {initial_count} → {len(filtered_df)} "
...
class DataQualityFilter:
    ...
    def filter_by_data_quality(
        ...
        try:
            ...
            self.logger.info(
                f"Data quality filter: {initial_count} → {final_count} "
...
class CustomFilter:
    ...
    def add_filter(
        self, filter_func: Callable[[pd.DataFrame], pd.DataFrame], name: str = None
    ) -> None:
        """
