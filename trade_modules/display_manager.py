...
class DisplayManager:
    ...
    def prepare_dataframe(
        self, df: pd.DataFrame, option: str, sub_option: str = None, output_type: str = "console"
    ) -> pd.DataFrame:
        """
        ...
        if sort_config.get("sort_by") and sort_config["sort_by"] in result_df.columns:
            ...
            result_df = result_df.sort_values(
                by=sort_config["sort_by"], ascending=ascending
    ...
    def save_csv(
        self, df: pd.DataFrame, file_path: str, option: str, sub_option: str = None
    ) -> None:
        """
