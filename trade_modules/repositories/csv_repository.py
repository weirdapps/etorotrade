...
class CsvRepository(ICsvRepository):
    ...
    def read_csv(self, file_path: str | Path, **kwargs) -> pd.DataFrame:
        ...
        except (FileNotFoundError, pd.errors.EmptyDataError, OSError, ValueError, KeyError) as e:
    ...
    def write_csv(self, file_path: str | Path, data: pd.DataFrame, **kwargs) -> bool:
        """
    ...
    def backup_file(self, identifier: str, backup_suffix: str | None = None) -> bool:
        """
