...
# Eagerly bind submodules that mock.patch() needs to address by dotted path.
# Without this, `mock.patch("trade_modules.earnings_proximity.X")` fails with
# `AttributeError: module 'trade_modules' has no attribute 'earnings_proximity'`.
from . import earnings_proximity  # noqa: F401, E402
