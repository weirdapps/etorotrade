...
def clean_ticker_object(ticker_obj: Any) -> None:
    ...
    problematic_attrs = [
        ...
        '_recommendations', '_isin', '_major_holders', '_institutional_holders',
        '_mutualfund_holders', '_info', '_sustainability', '_calendar',
        '_expirations', '_options', '_earnings_dates', '_history',
        '_actions', '_dividends', '_splits', '_capital_gains',
        '_shares', '_quarterly_earnings', '_quarterly_financials',
        '_quarterly_balance_sheet', '_quarterly_cashflow'
    ]
