...
async def retry_async_with_backoff(
    ...
    **kwargs,
    ...
    # Assertion narrows the type for SonarCloud's flow analysis.
    assert all(isinstance(e, type) and issubclass(e, BaseException) for e in retry_exceptions)
    ...
    while attempt <= max_retries:
        ...
        except retry_exceptions as e:  # NOSONAR — retry_exceptions is asserted to be tuple[type[BaseException], ...] above
            attempt += 1
            last_exception = e
