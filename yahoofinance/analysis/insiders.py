...
class InsiderAnalyzer:
    ...
    def __init__(self, provider: Optional[Union[FinanceDataProvider, AsyncFinanceDataProvider]] = None):
        ...
        self.is_async = hasattr(self.provider, 'get_insider_transactions') and \
                        callable(self.provider.get_insider_transactions) and \
                        hasattr(self.provider.get_insider_transactions, '__await__')
    ...
    def get_transactions(self, ticker: str, days: int = 90) -> InsiderSummary:
        ...
        """
        if self.is_async:
            raise TypeError("Cannot use sync method with async provider. Use get_transactions_async instead.")
    ...
    async def get_transactions_async(self, ticker: str, days: int = 90) -> InsiderSummary:
        ...
        if not self.is_async:
            raise TypeError("Cannot use async method with sync provider. Use get_transactions instead.")
    ...
    def get_transactions_batch(self, tickers: List[str], days: int = 90) -> Dict[str, InsiderSummary]:
        """
        ...
        """
        if self.is_async:
            raise TypeError("Cannot use sync method with async provider. Use get_transactions_batch_async instead.")
    ...
    async def get_transactions_batch_async(self, tickers: List[str], days: int = 90) -> Dict[str, InsiderSummary]:
        """
        ...
        """
        if not self.is_async:
            raise TypeError("Cannot use async method with sync provider. Use get_transactions_batch instead.")
    ...
    def analyze_insider_sentiment(self, ticker: str, days: int = 90) -> Dict[str, Any]:
        ...
        """
        if self.is_async:
            raise TypeError("Cannot use sync method with async provider. Use analyze_insider_sentiment_async instead.")
    ...
    async def analyze_insider_sentiment_async(self, ticker: str, days: int = 90) -> Dict[str, Any]:
        ...
        """
        if not self.is_async:
            raise TypeError("Cannot use async method with sync provider. Use analyze_insider_sentiment instead.")
